"use strict";
const version = 2, canvas = document.querySelector("#glcanvas");
var gl, wasm_memory, animation_frame_timeout, FS, GL, Module, wasm_exports, emscripten_shaders_hack, importObject,
    clipboard = null, plugins = [], high_dpi = !1, blocking_event_loop = !1;
...
canvas.focus(), canvas.requestPointerLock = canvas.requestPointerLock || canvas.mozRequestPointerLock || function () {
...
function stringToUTF8(e, t, n, s) {
    for (var o, r, c = n, i = n + s, a = 0; a < e.length; ++a) if (o = e.charCodeAt(a), o >= 55296 && o <= 57343 && (r = e.charCodeAt(++a), o = 65536 + ((o & 1023) << 10) | r & 1023), o <= 127) {
        if (n >= i) break;
        t[n++] = o
    } else if (o <= 2047) {
        if (n + 1 >= i) break;
...
FS = {loaded_files: [], unique_id: 0}, GL = {
    ...
    getSource: function (e, t, n, s) {
        for (var a, i = "", o = 0; o < t; ++o) a = s == 0 ? 0[0] : getArray(s + o * 4, Uint32Array, 1)[0], i += UTF8ToString(getArray(n + o * 4, Uint32Array, 1)[0], a);
        return i
    },
    populateUniformTable: function (e) {
        ...
        }, d = r.uniforms, u = gl.getProgramParameter(o, 35718), c = 0; c < u; ++c) if (i = gl.getActiveUniform(o, c), t = i.name, r.maxUniformLength = Math.max(r.maxUniformLength, t.length + 1), t.slice(-1) == "]" && (t = t.slice(0, t.lastIndexOf("["))), n = gl.getUniformLocation(o, t), n) {
...
function _webglGet(e, t, n) {
    ...
    if (o === 0[0]) switch (s = gl.getParameter(e), typeof s) {
        case"number":
            o = s;
            break;
        case"boolean":
...
function mouse_relative_position(e, t) {
    var n = canvas.getBoundingClientRect(), s = (e - n.left) * dpi_scale(), o = (t - n.top) * dpi_scale();
    return {x: s, y: o}
}
...
emscripten_shaders_hack = !1, importObject = {
    env: {
        console_debug: function (e) {
            ...
            var e = GL.getNewId(GL.programs), t = gl.createProgram();
            ...
            if (t == 35716) s = gl.getProgramInfoLog(GL.programs[e]), assert(s !== null), getArray(n, Int32Array, 1)[0] = s.length + 1; else if (t == 35719) {
...
` + i)), gl.shaderSource(GL.shaders[e], o)
            ...
            var t = gl.getParameter(e).toString(), n = t.length + 1, s = wasm_exports.allocate_vec_u8(n),
            ...
            for (var n, o, s = 0; s < e; s++) {
                if (o = getArray(t + s * 4, Uint32Array, 1)[0], n = GL.renderbuffers[o], !n) continue;
            ...
            let o = gl.getQueryObject(GL.timerQueries[e], t), s = getArray(n, Uint32Array, 2);
            ...
            GL.validateGLObjectID(GL.renderbuffers, s, "glFramebufferRenderbuffer", "renderbuffer"), gl.framebufferRenderbuffer(e, t, n, GL.renderbuffers[s])
            ...
            canvas.onmousemove = function (e) {
                ...
                var n = into_sapp_keycode(e.code), t = 0;
                ...
                for (let n of e.dataTransfer.files) {
                    ...
                    const i = await n.arrayBuffer(), s = i.byteLength, a = wasm_exports.allocate_vec_u8(s),
...
function register_plugins(e) {
    if (e == null) return;
    for (var t = 0; t < e.length; t++) e[t].register_plugin != 0[0] && e[t].register_plugin != null && e[t].register_plugin(importObject)
}
...
function add_missing_functions_stabs(e) {
    ...
    for (const e in t) importObject.env[t[e].name] == 0[0] && (console.warn("No " + t[e].name + " function in gl.js"), importObject.env[t[e].name] = function () {
...
(function () {
        ...
        if (e == null) {
            ...
            let n = e.listener;
            {
                ...
                var t = function () {
                    ...
                    var i = n.createBuffer(1, 1, 22050), o = n.createBufferSource();
                    o.buffer = i, o.connect(n.destination), o.start ? o.start(0) : o.play ? o.play(0) : o.noteOn && o.noteOn(0), document.removeEventListener("touchstart", t), document.removeEventListener("touchend", t), document.removeEventListener("mousedown", t), document.removeEventListener("keydown", t)
                };
    ...
    function u(t, o, i) {
        let r = m++, a = l();
        a.sound_key = t, a.playback_key = r, a.source.connect(a.gain_node), a.gain_node.connect(e.destination), a.gain_node.gain.value = o, a.source.loop = i, a.ended = function () {
            s(a)
    ...
    miniquad_add_plugin({
        register_plugin: function (e) {
            e.env.audio_init = d, e.env.audio_add_buffer = r, e.env.audio_play_buffer = u, e.env.audio_source_is_loaded = a, e.env.audio_source_set_volume = h, e.env.audio_source_stop = i, e.env.audio_source_delete = f, e.env.audio_playback_stop = p, e.env.audio_playback_set_volume = g
    ...
    function o(n) {
        n.env.js_create_string = function (e, n) {
            ...
            var a = UTF8ToString(n, s), r = UTF8ToString(o, i);
            e[t][a] = r
    ...
    register_plugin = function (e) {
        e.env.ws_connect = r, e.env.ws_is_connected = a, e.env.ws_send = c, e.env.ws_try_recv = l, e.env.http_make_request = u, e.env.http_try_recv = d
    ...
    function r(t) {
        e = new WebSocket(consume_js_object(t)), e.binaryType = "arraybuffer", e.onopen = function () {
            o = 1
        }, e.onmessage = function (e) {
            if (typeof e.data == "string") n.push({text: 1, data: e.data}); else {
    ...
    function u(e, n, o, i) {
        var a, r, c, d, u, l = s;
        s += 1, e == 0 && (r = "POST"), e == 1 && (r = "PUT"), e == 2 && (r = "GET"), e == 3 && (r = "DELETE"), d = consume_js_object(n), u = consume_js_object(o), c = consume_js_object(i), a = new XMLHttpRequest, a.open(r, d, !0), a.responseType = "arraybuffer";
